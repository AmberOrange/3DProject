...
DInput::DInput(const DInput &other)
{
}
...
bool DInput::IsKeyPressed(unsigned int key)
{
	if (key <= 255)
...
void DInput::GetMouseMovement(int &mouseX, int &mouseY)
{
	mouseX = m_mouseMoveX;
	mouseY = m_mouseMoveY;
}
...
void DInput::ProcessInput()
{
	...
	m_mouseMoveX = m_mouseState.lX;
	m_mouseMoveY = m_mouseState.lY;
